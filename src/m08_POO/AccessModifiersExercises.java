...
public class AccessModifiersExercises {
    ...
    static void main() {
        Person person12 = new Person("Kevin", 32, 1.76, 86, "Masculino");
        person12.sayHelloWithAge();
        person12.setAge(18);
        System.out.println("Hello, my age is: " + person12.getAge());
        person12.setName("Alvaro");
